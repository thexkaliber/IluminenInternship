...
def gui():
    ...
    entry_1.bind("<Return>",lambda enable:enable_entry(entry_1, entry_2)) #After entering details, if Enter is hit, next Entry is enabled.
    ...
    entry_2.bind("<Return>",lambda enable:enable_entry(entry_2, entry_3))
    ...
    entry_3.bind("<Return>",lambda enable:enable_entry(entry_3, entry_4))
    ...
    entry_4.bind("<Return>",lambda enable:enable_entry(entry_4, entry_5))
    ...
    entry_5.bind("<Return>",lambda enable:enable_entry(entry_5))
